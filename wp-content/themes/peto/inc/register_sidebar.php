...
$ftc_default_sidebars = array(
						array(
							'name' => esc_html__( 'Home Sidebar', 'peto' ),
							'id' => 'home-sidebar',
							'description' => '',
						...
						,array(
							'name' => esc_html__( 'Blog Sidebar', 'peto' ),
							'id' => 'blog-sidebar',
							'description' => '',
							'before_widget' => '<section id="%1$s" class="widget-container %2$s">',
							'after_widget' => '</section>',
						...
						,array(
							'name' => esc_html__( 'Blog Detail Sidebar', 'peto' ),
						...
						,array(
							'name' => esc_html__( 'Product Category Sidebar', 'peto' ),
						...
						,array(
							'name' => esc_html__( 'Product Category Top Content', 'peto' ),
						...
						,array(
							'name' => esc_html__( 'Product Detail Sidebar', 'peto' ),
						...
						,array(
							'name'          => esc_html__( 'Product Detail Social Icon', 'peto' ),
                                                        'id'            => 'product-detail-social-icon',
                                                        'before_widget' => '<div id="%1$s" class="widget %2$s">',
                                                        'after_widget' => '</div>',
                                                        'description'   => esc_html__( 'Add social icon in your product detail page.', 'peto' ),
						)
						,array(
							'name'          => esc_html__( 'Popup Newletter', 'peto' ),
							'id'            => 'popup-newletter',
							'before_widget' => '<div id="%1$s" class="widget %2$s">',
							'after_widget' => '</div>',
							'description'   => '',
...
$ftc_default_widgetareas = array(
                                        array(
							'name'          => esc_html__( 'Footer Top', 'peto' ),
                                                        'id'            => 'footer-top',
                                                        'before_widget' => '<div id="%1$s" class="widget %2$s">',
                                                        'after_widget' => '</div>',
                                                        'description'   => esc_html__( 'Add widgets here to appear in your footer.', 'peto' ),
					)
					,array(
							'name'          => esc_html__( 'Footer Middle', 'peto' ),
                                                        'id'            => 'footer-middle',
                                                        'before_widget' => '<div id="%1$s" class="widget %2$s">',
                                                        'after_widget' => '</div>',
                                                        'description'   => esc_html__( 'Add widgets here to appear in your footer.', 'peto' ),
					...
					,array(
							'name'          => esc_html__( 'Footer Bottom', 'peto' ),
                                                        'id'            => 'footer-bottom',
                                                        'before_widget' => '<div id="%1$s" class="widget %2$s">',
                                                        'after_widget' => '</div>',
                                                        'description'   => esc_html__( 'Add widgets here to appear in your footer.', 'peto' ),
