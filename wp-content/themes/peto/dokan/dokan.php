...
final class WeDevs_Dokan {
    ...
    public function activate() {
        if ( ! function_exists( 'WC' ) ) {
            ...
            wp_die( '<div class="error"><p>' . sprintf( __( '<b>Dokan</b> requires %sWooCommerce%s to be installed & activated!', 'peto' ), '<a target="_blank" href="https://wordpress.org/plugins/woocommerce/">', '</a>' ) . '</p></div>' );
        }
    ...
    public function localization_setup() {
        load_plugin_textdomain( 'peto', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
    }
    ...
    function includes() {
        ...
        // widgets
        require_once  'widgets/menu-category.php';
    ...
    function plugin_action_links( $links ) {
        ...
        if ( !$this->is_pro_exists() ) {
            $links[] = '<a href="https://wedevs.com/dokan/" style="color: #389e38;font-weight: bold;" target="_blank">' . __( 'Get Pro', 'peto' ) . '</a>';
        }

        $links[] = '<a href="' . admin_url( 'admin.php?page=dokan-settings' ) . '">' . __( 'Settings', 'peto' ) . '</a>';
        $links[] = '<a href="https://docs.wedevs.com/docs/dokan/" target="_blank">' . __( 'Documentation', 'peto' ) . '</a>';
