	...
	<div class="footer-mobile">
		<div class="mobile-home">
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>" >
				...
				<?php esc_html_e('Home','peto'); ?>
			</a>   
		</div>  
		<div class="mobile-view-cart" >
			<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" >
				<i class="fa fa-shopping-cart"></i>
				<?php esc_html_e('Cart','peto'); ?>
		...
		<div class="mobile-account">
			...
			ob_start();
			?>
			<a href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id') ) ); ?>" title="<?php esc_html_e('Login','peto'); ?>">
				<i class="fa fa-user"></i>
				<?php if ($_user_logged): ?>
					<?php esc_html_e('Account','peto'); ?>
				<?php endif; ?>
				<?php if (!$_user_logged): ?>
					<?php esc_html_e('Login','peto'); ?>
				<?php endif; ?>
			</a>
		</div>
	</div>
...
<div id="to-top" class="scroll-button">
	<a class="scroll-button" href="javascript:void(0)" title="<?php esc_html_e('Back to Top', 'peto'); ?>"><?php esc_html_e('Back to Top', 'peto'); ?></a>
</div>
<?php endif; ?>	
